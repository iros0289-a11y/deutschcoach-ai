...
export const writingScenarios: WritingScenario[] = [
  ...
  },
  {
    ...
    situation: "Sie haben einen Beratungstermin in der Berufsschule, können aber nicht kommen.",
    points: ["Termin nennen", "Grund erklären", "um neuen Termin bitten", "Erreichbarkeit nennen"],
    tips: ["den Termin genau nennen", "kurz begründen", "freundlich um einen neuen Vorschlag bitten"],
    sampleSubject: "Bitte um neuen Beratungstermin",
    sampleText:
      "Sehr geehrte Damen und Herren,\n\nich habe am Mittwoch um 14 Uhr einen Beratungstermin in Ihrer Berufsschule. Leider kann ich an diesem Tag nicht kommen, weil ich einen wichtigen Arzttermin habe. Ich möchte Sie deshalb um einen neuen Termin in der nächsten Woche bitten. Sie können mich gern per E-Mail oder telefonisch unter 0176 88990011 erreichen.\n\nMit freundlichen Grüßen\nNesrin Yilmaz"
  },
  {
    id: "write-22",
    title: "Beschwerde über das Fitnessstudio",
    category: "Freizeit",
    recipient: "die Studioleitung",
    situation: "Im Fitnessstudio funktionieren mehrere Geräte seit Tagen nicht.",
    points: ["Problem beschreiben", "seit wann nennen", "um Reparatur bitten", "eine Rückmeldung wünschen"],
    tips: ["sachlich formulieren", "den Zeitraum nennen", "klare Bitte schreiben"],
    sampleSubject: "Defekte Geräte im Fitnessstudio",
    sampleText:
      "Sehr geehrte Damen und Herren,\n\nich trainiere regelmäßig in Ihrem Fitnessstudio. Seit einigen Tagen funktionieren mehrere Geräte im großen Trainingsraum nicht mehr, zum Beispiel zwei Laufbänder und ein Fahrrad. Deshalb müssen viele Mitglieder lange warten. Ich bitte Sie, die Geräte möglichst bald reparieren zu lassen. Bitte geben Sie mir kurz Bescheid, wann die Reparatur geplant ist.\n\nMit freundlichen Grüßen\nSibel Kaya"
  },
  {
    id: "write-23",
    ...
    situation: "Sie müssen wegen eines wichtigen Amtsbesuchs später zur Arbeit kommen.",
    points: ["Grund nennen", "ungefaehre Ankunftszeit nennen", "sich entschuldigen", "Arbeit danach bestätigen"],
    tips: ["sofort den Grund nennen", "eine realistische Uhrzeit schreiben", "kurz und klar bleiben"],
    sampleSubject: "Ich komme morgen später",
    sampleText:
      "Guten Abend Herr Reuter,\n\nmorgen muss ich morgens zum Bürgeramt, weil ich dort einen wichtigen Termin habe. Deshalb kann ich nicht pünktlich um 8 Uhr bei der Arbeit sein. Ich werde voraussichtlich gegen 10 Uhr im Büro ankommen. Entschuldigen Sie bitte die Unannehmlichkeiten. Danach arbeite ich wie geplant weiter und erledige auch meine Aufgaben für das Teammeeting.\n\nFreundliche Grüße\nYusuf Demir"
  },
  {
    id: "write-24",
    title: "Anfrage beim Reisebüro",
    category: "Reisen",
    recipient: "das Reisebüro Sonnenklar",
    situation: "Sie möchten eine Busreise buchen und brauchen noch Informationen.",
    points: ["Interesse nennen", "nach Reisedatum fragen", "nach Preis fragen", "nach Leistungen fragen"],
    tips: ["alle Fragen in einem Text sammeln", "freundlich bleiben", "mit Dank schließen"],
    sampleSubject: "Fragen zu Ihrer Busreise",
    sampleText:
      "Sehr geehrte Damen und Herren,\n\nich interessiere mich für Ihre Busreise nach Hamburg. Bevor ich buche, möchte ich noch einige Informationen bekommen. Bitte schreiben Sie mir, an welchem Datum die nächste Reise stattfindet, wie viel sie kostet und welche Leistungen im Preis enthalten sind. Ich möchte zum Beispiel wissen, ob das Frühstueck und die Hotelübernachtung dabei sind.\n\nVielen Dank für Ihre Antwort.\nMit freundlichen Grüßen\nAmina Sahin"
  }
];
...
export const speakingPlanningTasks: SpeakingPlanningTask[] = [
    ...
    },
  {
    ...
    roleA: ["Uhrzeit für den Start festlegen", "Transporter organisieren", "Helfer fragen", "Getränke besorgen"],
    roleB: ["Kartons mitbringen", "alte Wohnung sauber machen", "Mittagessen planen", "Rückgabe des Schlüssels bedenken"],
    usefulPhrases: ["Wir sollten zuerst ...", "Kannst du vielleicht ...?", "Das übernehme ich.", "Dann sind wir fertig."],
    sampleDirection:
      "Beide einigen sich auf einen frühen Start, teilen Transport, Helfer und Essen auf und denken auch an die Schlüsselübergabe."
  },
  {
    id: "plan-07",
    title: "Schulfest vorbereiten",
    setting: "Sie möchten mit einem anderen Elternteil einen Stand für das Schulfest planen.",
    roleA: ["welchen Stand anbieten", "Material einkaufen", "Uhrzeit für den Aufbau", "Preise festlegen"],
    roleB: ["Helferinnen und Helfer finden", "Kasse organisieren", "Dekoration mitbringen", "am Ende aufräumen"],
    usefulPhrases: ["Wie findest du ...?", "Wir brauchen auf jeden Fall ...", "Das kann ich machen.", "Einverstanden, dann machen wir das so."],
    sampleDirection:
      "Die Partner entscheiden sich für einen Kuchenstand, planen den Aufbau am Morgen und teilen Einkauf, Kasse und Aufräumen auf."
  },
  {
    id: "plan-08",
    title: "Gemeinsamer Einkauf",
    setting: "Sie möchten mit einer Nachbarin für ein Abendessen gemeinsam einkaufen gehen.",
    roleA: ["Treffpunkt nennen", "Einkaufsliste machen", "Budget beachten", "wer was bezahlt"],
    roleB: ["passendes Geschäft vorschlagen", "Transport der Taschen", "eine vegetarische Option planen", "Uhrzeit für das Kochen festlegen"],
